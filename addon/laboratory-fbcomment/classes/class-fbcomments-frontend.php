    ...
    public function laboratory_fbcomments_shortcode($fbatts) {
        ...
        if (!empty($fbatts)) {
            ...
            if ($lab_fbcomments['html5']) {
                $fbcommentbox .= "<div class=\"fb-comments\" data-href=\"".$url."\" data-num-posts=\"".$lab_fbcomments['num']."\" data-width=\"".$lab_fbcomments['width']."\" data-colorscheme=\"".$lab_fbcomments['scheme']."\"></div>";
