...
if ( ! empty( $post->id ) ) {
	$nonce_action = 'crm-update-contact_' . $post->id;
} else {
	$nonce_action = 'crm-add-contact';
}
...
<h2><?php echo esc_html( __( 'Edit Contact', 'crm' ) ); ?></h2>
...
<?php else : ?>
<label class="hide-if-no-js" style="visibility:hidden" id="title-prompt-text" for="title"><?php echo esc_html( __( 'Enter email here', 'crm' ) ); ?></label>
