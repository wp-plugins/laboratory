jQuery(document).ready( function($) {
	...
	jQuery( '#laboratory_slideshow .subsubsub a.tab' ).click( function ( e ) {
		...
		if ( jQuery( this ).hasClass( 'all' ) ) {
			jQuery( '#laboratory_slideshow h3, #laboratory_slideshow form p, #laboratory_slideshow table.form-table, p.submit' ).show();
