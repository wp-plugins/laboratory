...
/**
 * Laboratory Utils Class
 *
 * A class containing various Laboratory utilities.
 *
 * @package WordPress
...
class Laboratory_Utils {
	...
	public static function load_common_l10n () {
		$strings = array(
						...
						'disabled' => __( 'Deactivated', 'laboratory' ), 
						'enabled' => __( 'Activated', 'laboratory' ), 
						'enabled_successfully' => __( '%s Activated Successfully', 'laboratory' ), 
						'disabled_successfully' => __( '%s Deactivated Successfully', 'laboratory' ), 
						'enabled_error' => __( 'There was an error activating %s', 'laboratory' ), 
						'disabled_error' => __( 'There was an error deactivating %s', 'laboratory' )
						);
