...
?>
<div class="laboratory_twitter_stream">
		...
		<div class="laboratory-sidebar">
			<div class="laboratory-logo">
				...
				<h3>
					...
					<a href="http://colorlabsproject.com/plugins/laboratory/" target="_blank" title="ColorLabs & Company"><?php echo esc_html( $this->name ); ?></a> <span class="version"><?php echo esc_html( $laboratory->version ); ?></span>
				</h3>
			</div>
